...
//		 String url="http://www.kanshuhai.com/0/0/616/310475.shtml";
		String url="https://baike.baidu.com/tashuo/browse/content?id=d73dbd026602f4d1df20c065&fr=kgDateCardPc";
		 //17460018.shtml
		 logger.info("开始执行!");
		 try {
...
//					 logger.info(ele.text());
					 logger.info(doc.getElementsByClass("article art-widget-box").text());
					 logger.info(doc.getElementsByClass("article art-widget-box").html());
				 }catch (Exception e) {
